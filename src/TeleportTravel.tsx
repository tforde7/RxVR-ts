	...
	return (
		<>
			...
			<mesh position={[0, 0.25, 0]}>
                <boxGeometry args={[0.1, 0.5, 0.1]} attach="geometry" />
...
export default function TeleportTravel(props: { children?: any; centerOnTeleport?: any; Indicator?: any; useNormal?: any; }) {
	const {
		centerOnTeleport,
	...
	const targetLoc: MutableRefObject<any> = useRef();
	...
	useFrame(() => {
		if (
			...
			if (intersection) {
if (useNormal && intersection.face) {
